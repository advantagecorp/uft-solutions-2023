WpfWindow("Micro Focus MyFlight Sample").WpfComboBox("fromCity").Select DataTable("p_fromCity", dtGlobalSheet) @@ hightlight id_;_1958781272_;_script infofile_;_ZIP::ssf3.xml_;_
WpfWindow("Micro Focus MyFlight Sample").WpfComboBox("toCity").Select DataTable("p_toCity", dtGlobalSheet) @@ hightlight id_;_1958781800_;_script infofile_;_ZIP::ssf5.xml_;_
...
Wait 5
WpfWindow("Micro Focus MyFlight Sample").WpfObject("Price").Check CheckPoint("PriceCheck")
