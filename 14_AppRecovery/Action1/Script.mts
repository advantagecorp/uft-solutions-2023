WpfWindow("Micro Focus MyFlight Sample").WpfComboBox("fromCity").Select "Denver" @@ hightlight id_;_1958781272_;_script infofile_;_ZIP::ssf3.xml_;_
WpfWindow("Micro Focus MyFlight Sample").WpfComboBox("toCity").Select "Frankfurt" @@ hightlight id_;_1958781800_;_script infofile_;_ZIP::ssf5.xml_;_
WpfWindow("Micro Focus MyFlight Sample").WpfCalendar("datePicker").SetDate DataTable("p_Date", dtGlobalSheet) @@ hightlight id_;_1958782280_;_script infofile_;_ZIP::ssf6.xml_;_
...
WpfWindow("Micro Focus MyFlight Sample").WpfEdit("passengerName").Set "John Jackson" @@ hightlight id_;_1997141616_;_script infofile_;_ZIP::ssf15.xml_;_
