WpfWindow("Micro Focus MyFlight Sample").WpfComboBox("fromCity").Select DataTable("p_Departure", dtGlobalSheet) @@ hightlight id_;_1958781272_;_script infofile_;_ZIP::ssf3.xml_;_
WpfWindow("Micro Focus MyFlight Sample").WpfComboBox("toCity").Select DataTable("p_Arrival", dtGlobalSheet) @@ hightlight id_;_1958781800_;_script infofile_;_ZIP::ssf5.xml_;_
